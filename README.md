...
<img src="https://img.shields.io/badge/Version-1.3.6-blue?style=for-the-badge&logo=gnu-bash&logoColor=white" alt="Version 1.3.6">   
...
- **Key variables**: Hard-coded `APP_NAME="pomo"`, `APP_VER="1.3.6"`, GitHub `SCRIPT_URL`; `VOLATILE_DIR="/tmp"` (portable timer files), `PERSISTENT_DIR="~/.cache/pomo"` (XDG-safe stats/theme) .
