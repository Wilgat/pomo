...
| requirement-shell-pomo-domain | Pomodoro domain (work/break, themes, stats, path-safe names, storage) | shell | Active | `requirement-shell-pomo-domain.md` | 2026-07-14 |
