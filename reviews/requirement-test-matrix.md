...
**Product:** pomo  
**Updated:** 2026-09-15 (TP-LC-24/25 global dest 0755)  
...
| `RQ-SHELL-SCRIPT-CODING` | requirement-shell-script-coding | **TP-CLI-01**, **TP-CITE-01**, **TP-TX-01..05**, **TP-TX-08..10** | `tests/test_cli.sh` + static header | have |
| `RQ-SHELL-CLI-INTERFACE` | requirement-shell-cli-interface | **TP-CLI-01..13**, **TP-CLI-16/17/29/30**, **TP-TX-01..05**, **TP-TX-08..10**, **TP-POMO-01** | `tests/test_cli.sh`, `tests/test_pomo_domain.sh` | have (05/10 n/a; TX-06/07 n/a) |
...
| `RQ-SHELL-SELF-MANAGEMENT` | requirement-shell-self-management | **TP-LC-04/05/05b/07/08/11/23/24/25**, **TP-CLI-11**, **TP-TX-01..05**, **TP-TX-08** | `tests/test_install_lifecycle.sh`, `tests/test_cli.sh` | have |
...
| `RQ-SHELL-MODULAR-FUNCTION-DESIGN` | requirement-shell-modular-function-design | **TP-CLI-01**, **TP-CITE-01**, **TP-POMO-***, **TP-TX-*** | CLI + domain | have |
| `RQ-DOMAIN-POMO` | requirement-domain-pomo | **TP-POMO-01..11**, **TP-STORAGE-01..03**, **TP-TX-08..12** | `tests/test_pomo_domain.sh`, `tests/test_cli.sh` | have (**TP-POMO-08** retired → **TP-STORAGE-02**) |
| `RQ-SHELL-GIT-BASH` | requirement-shell-git-bash | **TP-CLI-13**, **TP-TX-09..12** | `tests/test_cli.sh` | have |
| `RQ-SHELL-CLI-STORAGE` | requirement-shell-cli-storage | **TP-STORAGE-01..03**, **TP-TX-08..10**, **TP-TX-12** | `tests/test_pomo_domain.sh`, `tests/test_cli.sh` | have |
...
| `checklist-online-install-script` | `curl \| sh` / companion / dest **0755** | **TP-CURL** + **TP-CSUM** + **TP-LC-23** + **TP-LC-24** + **TP-LC-25** |
