...
| `RQ-DOMAIN-POMO` | requirement-domain-pomo | **TP-POMO-01..11**, **TP-STORAGE-01..03**, **TP-TX-08** | `tests/test_pomo_domain.sh`, `tests/test_cli.sh` | have (**TP-POMO-08** retired → **TP-STORAGE-02**) |
