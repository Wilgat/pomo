...
|-------|------|-------------|--------|
| CLI surface | `test_cli.sh` | **TP-CLI**, **TP-CSUM-01/05**, **TP-U-01/02**, **TP-TX-01..05**, **TP-TX-08** | syntax, companion, version/help/about, domain help rows, quiet, uninstall refuse, zero-arg fail; Termux dest + `$PREFIX/tmp` |
