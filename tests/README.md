...
**ID notation:** stack **TP-CLI / TP-LC / TP-CSUM / TP-U / TP-CURL / TP-TX**; shared storage **TP-STORAGE** (timer/countdown/pomo); domain ops **TP-POMO-*** → **RQ-DOMAIN-POMO**
...
|-------|------|-------------|--------|
| CLI surface | `test_cli.sh` | **TP-CLI**, **TP-CSUM-01/05**, **TP-U-01/02**, **TP-CLI-16/17/29/30**, **TP-TX-01..05**, **TP-TX-08** | syntax, companion, version/help/about, TTY menu, quiet, uninstall refuse, zero-arg fail; Termux dest + `$PREFIX/tmp` |
| Install lifecycle | `test_install_lifecycle.sh` | **TP-LC**, **TP-LC-23/24/25**, **TP-CSUM-02..04** | local channel install, dest **0755**, **global** dest 0755 (install + self-update), Type O ensure, pin, downgrade |
