...
| Install lifecycle | `test_install_lifecycle.sh` | **TP-LC**, **TP-LC-23**, **TP-CSUM-02..04** | local channel install, dest **0755**, Type O ensure, self-update, pin, downgrade, PATH cleanup |
