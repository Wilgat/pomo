...
#               RQ-SHELL-INTERACTIVE-VS-NONINTERACTIVE; TP-U-03 via TP-CURL-04.
# =============================================================================
...
run_test_online_curl_install() {
    ...
    # Config SSOT uses either APP_NAME="…" or : "${APP_NAME:=…}"
    case "$_out" in
    ...
    # --- TP-CURL-04 / TP-U-03: bashrc stub under set -u (direct) ---
    # Product does not source bashrc; verify version still loud under hostile HOME.
